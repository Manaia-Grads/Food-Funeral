...
import { fetchPosts, GET_POSTS_REQUEST, GET_POSTS_SUCCESS, GET_POSTS_FAILURE, } from '../posts'
...
describe('fetchPosts', () => {
  ...
  it('should dispatch the GET_POSTS_FAILURE action if the promise rejects', () => {
    ...
    return fetchPosts()(fakeDispatch).then(() => {
      ...
      expect(fakeDispatch.mock.calls[1][0].payload.errMessage).toBe('uh oh, no worky')
